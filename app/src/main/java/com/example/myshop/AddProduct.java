...
public class AddProduct extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spin = (Spinner) findViewById(R.id.unit);
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    Toast.makeText(AddProduct.this, "Image Saved!", Toast.LENGTH_SHORT).show();
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long id) {
        Toast.makeText(AddProduct.this,country[position] , Toast.LENGTH_LONG).show();
    }
